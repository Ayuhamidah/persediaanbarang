...
$(document).ready(function() {
	$("#data").load('modul/lap_beli/tampil_data.php');
	...
	$("#cetak").click(function() {
		...
		/*
	   	$.ajax({
			type	: "GET",
			url		: "modul/laporan/lap_beli.php",
			data	: "kode1="+kode1+"&kode2="+kode2,
			success	: function(data){
				//$("#data").html(data);
...
<?php
echo "<div id='form' align='center'><h2>LAPORAN DATA PEMBELIAN <h3></div>";
echo "<div id='filter' align='center'>
	<fieldset>
		<legend>Filter Data </legend>
		<table width='100%'>
			<tr>
				<td width='10%'>Kode Beli</td>
				<td width='2%'>:</td>
				<td ><select nama='kode1' id='kode1'>
				<option value=''>-Pilih Kode-</option>";
				$query	= "SELECT * FROM beli ORDER BY kode_barang";
