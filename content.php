...
//pembeli
elseif ($mod=='pembeli'){
    include "modul/pembeli/pembeli.php";
}
...
elseif ($mod=='hutang'){
    include "modul/hutang/hutang.php";
}
elseif ($mod=='piutang'){
...
elseif ($mod=='lap_beli'){
    include "modul/lap_beli/lap_beli.php";
}

elseif ($mod=='lap_jual'){
    include "modul/lap_jual/lap_jual.php";
}
